...
export function CamposConjunto({ v, categoria = true }: { v?: ValoresCadastro; categoria?: boolean }) {
  return (
    <>
      ...
      <div><label className={rotulo}>Nome do cavalo <span className="text-red">*</span></label>
        <input name="cavalo" defaultValue={v?.cavalo} placeholder="Nome da montada" required className={campoCad} autoComplete="off" /></div>
